...
// A round is one line of scoring for a given set of players
// for example scores[playerId] = 123
...
class Round with MyMixin {
  ...
  void initPlayerScores(List<Player> players) {
    for (Player p in players) {
      scores[p.id] = 0;
    }
  }
  ...
  factory Round.fromMap(Map<String, dynamic> map) {
    ...
    final id = map['id'];
    final roundLabel = map['roundLabel'];
