...
import 'package:scores/screens/match_player_stats_list_screen.dart';
...
class _MatchStatsListScreenState extends State<MatchStatsListScreen> {
  ...
  Future<void> _loadMatchStats() async {
    ...
    // setState(() {
    //   matchStats = [
    //     MatchStats(id: 1, matchId: 101, stat: 'total_score', value: '150'),
    //     MatchStats(id: 2, matchId: 101, stat: 'duration', value: '45'),
    //     MatchStats(id: 3, matchId: 102, stat: 'total_score', value: '200'),
    //     MatchStats(id: 4, matchId: 102, stat: 'duration', value: '60'),
    //     MatchStats(id: 5, matchId: 103, stat: 'total_score', value: '175'),
    //   ];
    //   isLoading = false;
    // });
  }
